...
<a href="javascript:;" onclick="showInfo()">如何获取密码？</a>
					...
					<div class="container-login100-form-btn">
						<div class="wrap-login100-form-btn">
							...
							<?php if($postpwd): ?>
							<script>setTimeout(function() {document.getElementById(layer.tips('警告：密码错误！','#', {tips: [1, '#ec4848'],time: 9000}))}, 30);</script>
							<?php endif; ?>
                            </form>
						</div>
					</div>
					...
					<div class="flex-col-c p-t-25">
						<a href="https://www.baidu.com/" class="txt2">返回首页</a>
					</div>
...
<script type="text/javascript">
        ...
        ,content: '<div style="padding: 20px; line-height: 22px; background-color: #495057; color: #fff; font-weight: 300;">联系管理员获取<br><br>未公开<br><br><!--img src="qr-code.png" style="width:100%"</img--></div>'
